...
var PizzaComponent = /** @class */ (function () {
     ...
     * @return void
    */
    PizzaComponent.prototype.pagination = function (page_param) {
        var _this = this;
        var limits = 5;
        this.pizzaCharger = false;
        this.page_current = page_param;
        page_param = page_param > 0 ? page_param : this.page_current;
        this.http.get(__WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/pizza/' + page_param + "/" + limits)
            .map(function (response) { return response.json(); })
            .subscribe(function (data) {
            ...
            _this.paginate = page;
            console.log(data, page, _this.paginate);
        });
    };
