...
var DesertComponent = /** @class */ (function () {
     ...
     * @return void
    */
    DesertComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        ...
        if (is_paginate_allowed) {
            this.dessertsCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/dessert/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
                _this.desserts = data.contain;
                _this.dessertsCharger = (data.contain.length > 0) ? true : false;
                _this.p_prev = data.p_prev;
                _this.p_next = data.p_next;
                _this.page_current = data.p_current;
                _this.paginate_show = (data.count > _this.limits);
                var page = [];
                var max = Math.ceil(data.count / limits);
                for (var i = 1; i <= max; ++i) {
                    page.push(i);
                }
                _this.max_page = page.length;
                _this.paginate = page;
                if (page_param == 1)
                    _this.p_prev = 0;
                if (_this.p_next > _this.max_page)
                    _this.p_next = 0;
            });
        }
    };
...
var MenuComponent = /** @class */ (function () {
     ...
     * @return void
    */
    MenuComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.menusCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_5__config_host__["a" /* urlApi */] + '/menu/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
...
var PizzaComponent = /** @class */ (function () {
     ...
     * @return void
    */
    PizzaComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.pizzaCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/pizza/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
                _this.pizzas = data.contain;
                _this.pizzaCharger = (data.contain.length > 0) ? true : false;
                _this.p_prev = data.p_prev;
                _this.p_next = data.p_next;
                _this.page_current = data.p_current;
                _this.paginate_show = (data.count > _this.limits);
...
var PlatComponent = /** @class */ (function () {
     ...
     * @return void
    */
    PlatComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.platsCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_5__config_host__["a" /* urlApi */] + '/plat/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
